...
text_source: 道德经·通行本(王弼注);章节原文/今译/注释人工转录自 fundgao/DAO_DE_JING 并据其校勘修正(原 content-base AI 底本),帛书异文参考见各章注释
...
（81 章全文已录入：原文 + 今译 + 注释(逐句解释)。底本据 fundgao/DAO_DE_JING 通行本转录校勘修正，原 content-base AI 生成底本已替换。）
